										...
										<div class="form-row">
											...
											<div class="form-group col-md-12">
												<div id="box-foto-logo">
													...
													<a href="<?= base_url('uploads/paginas/dacao/pdf/' . $pdf->pdf_arquivo) ?>"><i style="font-size: 25pt" class='far fa-file-pdf'></i></a>
												...
												<?php if (isset($pdf)) : ?>
													<?php foreach ($pdf as $p) : ?>
														...
														<div class="form-group col-md-6">
															<a href="<?= BASE_URL('uploads/paginas/tce/pdf/') . $p->pdf_arquivo ?>" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a>
