...
<div id="preloader">
    <img src="<?= base_url('uploads/sistema/gif/'.$sistema->sistema_gif)?>" alt="<?=$sistema->sistema_site_titulo?>" title="<?=$sistema->sistema_site_titulo?>" style="position: absolute; left: 0; right: 0; margin: auto; top: 40%">
</div>
...
<script src="<?= base_url('public/web/assets/js/bootstrap.min.js'); ?>"></script>
...
<script src="<?= base_url('public/restrita/' . $script); ?>"></script>
