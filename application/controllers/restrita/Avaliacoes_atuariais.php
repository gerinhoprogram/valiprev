...
class Avaliacoes_atuariais extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'avaliacoes-atuariais';
		$this->pagina_titulo = 'Avaliações Atuariais';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'avaliacoes_atuariais';
		$this->folder_upload = './uploads/paginas/financeiro/avaliacoes_atuariais';
		$this->upload_view = 'uploads/paginas/financeiro/avaliacoes_atuariais/';
