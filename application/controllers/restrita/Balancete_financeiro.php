...
class Balancete_financeiro extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'balancete-financeiro';
		$this->pagina_titulo = 'Balancete financeiro';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'balancete_financeiro';
		$this->folder_upload = './uploads/paginas/financeiro/balancete_financeiro';
        $this->upload_view = 'uploads/paginas/financeiro/balancete_financeiro/';
