...
class Relatorios_analiticos extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'relatorios-analiticos';
		$this->pagina_titulo = 'Relatórios analíticos';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'relatorios_analiticos';
		$this->folder_upload = './uploads/paginas/financeiro/relatorios_analiticos';
        $this->upload_view = 'uploads/paginas/financeiro/relatorios_analiticos/';
