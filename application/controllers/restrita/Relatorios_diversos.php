...
class Relatorios_diversos extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'relatorios-diversos';
		$this->pagina_titulo = 'Relatórios diversos';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'relatorios_diversos';
		$this->folder_upload = './uploads/paginas/financeiro/relatorios_diversos';
        $this->upload_view = 'uploads/paginas/financeiro/relatorios_diversos/';
