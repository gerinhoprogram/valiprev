...
class Lrf extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'lrf';
		$this->pagina_titulo = 'LRF';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'lrf';
		$this->folder_upload = './uploads/paginas/financeiro/lrf';
		$this->upload_view = 'uploads/paginas/financeiro/lrf/';
