...
class Provisao_matematica_beneficios_concedidos extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'provisao-matematica-beneficios-concedidos';
		$this->pagina_titulo = 'Provisão matemática benefícios concedidos';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'Provisao_matematica_beneficios_concedidos';
		$this->folder_upload = './uploads/paginas/financeiro/provisao_matematica_beneficios_concedidos';
		$this->upload_view = 'uploads/paginas/financeiro/provisao_matematica_beneficios_concedidos/';
				...
				$this->redirecionar();
					...
					$data = array(
						...
						'scripts' => array(
							...
							'assets/jquery-upload-file/js/'.$this->view_folder.'.js',
