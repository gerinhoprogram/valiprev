...
class Receitas_financeiras extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'receitas-financeiras';
		$this->pagina_titulo = 'Receita Financeiras';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'receitas_financeiras';
		$this->folder_upload = './uploads/paginas/financeiro/receitas_financeiras';
        $this->upload_view = 'uploads/paginas/financeiro/receitas_financeiras/';
