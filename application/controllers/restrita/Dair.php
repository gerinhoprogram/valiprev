...
class Dair extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'dair';
		$this->pagina_titulo = 'Dair';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'dair';
		$this->folder_upload = './uploads/paginas/financeiro/dair';
		$this->upload_view = 'uploads/paginas/financeiro/dair/';
