...
class Aplicacoes_financeiras extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'aplicacoes-financeiras';
		$this->pagina_titulo = 'Aplicações Financeiras';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'aplicacoes_financeiras';
		$this->folder_upload = './uploads/paginas/financeiro/aplicacoes_financeiras';
		$this->upload_view = 'uploads/paginas/financeiro/aplicacoes_financeiras/';
