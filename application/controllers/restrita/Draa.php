...
class Draa extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'draa';
		$this->pagina_titulo = 'DRAA';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'draa';
		$this->folder_upload = './uploads/paginas/financeiro/draa';
		$this->upload_view = 'uploads/paginas/financeiro/draa/';
