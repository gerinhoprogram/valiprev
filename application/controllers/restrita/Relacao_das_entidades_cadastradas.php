...
class Relacao_das_entidades_cadastradas extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->url_pagina = 'relacao-das-entidades-cadastradas';
		$this->pagina_titulo = 'Relacão das entidades cadastradas';
		$this->tabela_banco = 'financeiro';
		$this->view_folder = 'relacao_das_entidades_cadastradas';
		$this->folder_upload = './uploads/paginas/financeiro/relacao_das_entidades_cadastradas';
		$this->upload_view = 'uploads/paginas/financeiro/relacao_das_entidades_cadastradas/';
