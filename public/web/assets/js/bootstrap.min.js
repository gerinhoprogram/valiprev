                ...
                if (this._isBodyOverflowing) {
                    Bt(re.FIXED_CONTENT).each(function(t, e) {
                        var n = Bt(e)[0].style.paddingRight,
                            i = Bt(e).css("padding-bottom");
                        Bt(e).data("padding-bottom", n).css("padding-bottom", parseFloat(i) + r._scrollbarWidth + "px")
                    ...
                    var t = document.body.style.paddingRight,
                        e = Bt(document.body).css("padding-bottom");
                    Bt(document.body).data("padding-bottom", t).css("padding-bottom", parseFloat(e) + this._scrollbarWidth + "px")
                }
            }, t._resetScrollbar = function() { Bt(re.FIXED_CONTENT).each(function(t, e) { var n = Bt(e).data("padding-bottom"); "undefined" != typeof n && Bt(e).css("padding-bottom", n).removeData("padding-bottom") }), Bt(re.STICKY_CONTENT + ", " + re.NAVBAR_TOGGLER).each(function(t, e) { var n = Bt(e).data("margin-right"); "undefined" != typeof n && Bt(e).css("margin-right", n).removeData("margin-right") }); var t = Bt(document.body).data("padding-bottom"); "undefined" != typeof t && Bt(document.body).css("padding-bottom", t).removeData("padding-bottom") }, t._getScrollbarWidth = function() {
