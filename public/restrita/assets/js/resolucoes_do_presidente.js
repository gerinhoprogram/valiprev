	...
	var envia_pdf = function() {
        ...
        $(document).on('change', '[name="pdf_arquivo"]', function() {
            ...
            $.ajax({
                ...
                type: 'post',
                url: BASE_URL + 'restrita/resolucoes_do_presidente/upload_pdf_unico',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    if (response.erro === 0) {
                        ...
                        $('#box-foto-logo').html(
							...
							"<a href='" + BASE_URL + "uploads/paginas/resolucoes_do_presidente/pdf/" + response.foto_nome + "'><i style='font-size: 25pt' class='far fa-file-pdf'></i></a>"+
