    ...
    var envia_foto = function() {
        ...
        $(document).on('change', '[name="pdf_arquivo"]', function() {
            ...
            $.ajax({
                ...
                type: 'post',
                url: BASE_URL + 'restrita/aplicacoes_financeiras/upload_pdf_unico',
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    if (response.erro === 0) {
						...
						$('#box-foto-logo').html(
                            ...
                            "<p><a href='" + BASE_URL + "uploads/paginas/financeiro/aplicacoes_financeiras/" + response.foto_nome + "' targe'_blank'><span class='badge badge-info'>Documento</span></a>"+
