...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e() }(this, (function() {
    ...
    const U = {
        ...
        Y = "right";
    class Q extends R {
        constructor(e, i) { super(e), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(i), this._indicatorsElement = t.findOne(".carousel_boot-indicators", this._element), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent), this._addEventListeners() }
        static get Default() { return $ }
        static get NAME() { return "carousel_boot" }
        ...
        pause(e) { e || (this._isPaused = !0), t.findOne(".carousel_boot-item-next, .carousel_boot-item-prev", this._element) && (r(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null }
        cycle(t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config && this._config.interval && !this._isPaused && (this._updateInterval(), this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)) }
        to(e) {
            this._activeElement = t.findOne(".active.carousel_boot-item", this._element);
            const i = this._getItemIndex(this._activeElement);
            if (e > this._items.length - 1 || e < 0) return;
            if (this._isSliding) return void H.one(this._element, "slid.bs.carousel_boot", () => this.to(e));
            if (i === e) return this.pause(), void this.cycle();
            const n = e > i ? V : K;
            this._slide(n, this._items[e])
        }
        _getConfig(t) { return t = {...$, ...t }, d("carousel_boot", t, F), t }
        _handleSwipe() {
        ...
        _addEventListeners() { this._config.keyboard && H.on(this._element, "keydown.bs.carousel_boot", t => this._keydown(t)), "hover" === this._config.pause && (H.on(this._element, "mouseenter.bs.carousel_boot", t => this.pause(t)), H.on(this._element, "mouseleave.bs.carousel_boot", t => this.cycle(t))), this._config.touch && this._touchSupported && this._addTouchEventListeners() }
        _addTouchEventListeners() {
            ...
            t.find(".carousel_boot-item img", this._element).forEach(t => { H.on(t, "dragstart.bs.carousel_boot", t => t.preventDefault()) }), this._pointerEvent ? (H.on(this._element, "pointerdown.bs.carousel_boot", t => e(t)), H.on(this._element, "pointerup.bs.carousel_boot", t => n(t)), this._element.classList.add("pointer-event")) : (H.on(this._element, "touchstart.bs.carousel_boot", t => e(t)), H.on(this._element, "touchmove.bs.carousel_boot", t => i(t)), H.on(this._element, "touchend.bs.carousel_boot", t => n(t)))
        }
        ...
        _getItemIndex(e) { return this._items = e && e.parentNode ? t.find(".carousel_boot-item", e.parentNode) : [], this._items.indexOf(e) }
        _getItemByOrder(t, e) {
            const i = t === V,
                n = t === K,
        ...
        _triggerSlideEvent(e, i) {
            const n = this._getItemIndex(e),
                s = this._getItemIndex(t.findOne(".active.carousel_boot-item", this._element));
            return H.trigger(this._element, "slide.bs.carousel_boot", { relatedTarget: e, direction: i, from: s, to: n })
        }
        ...
        _updateInterval() {
            const e = this._activeElement || t.findOne(".active.carousel_boot-item", this._element);
            if (!e) return;
        ...
        _slide(e, i) {
            const n = this._directionToOrder(e),
                s = t.findOne(".active.carousel_boot-item", this._element),
                o = this._getItemIndex(s),
                r = i || this._getItemByOrder(n, s),
                a = this._getItemIndex(r),
                l = Boolean(this._interval),
                c = n === V,
                d = c ? "carousel_boot-item-start" : "carousel_boot-item-end",
                h = c ? "carousel_boot-item-next" : "carousel_boot-item-prev",
                u = this._orderToDirection(n);
            if (r && r.classList.contains("active")) return void(this._isSliding = !1);
            if (this._triggerSlideEvent(r, u).defaultPrevented) return;
            if (!s || !r) return;
            this._isSliding = !0, l && this.pause(), this._setActiveIndicatorElement(r), this._activeElement = r;
            const f = () => { H.trigger(this._element, "slid.bs.carousel_boot", { relatedTarget: r, direction: u, from: o, to: a }) };
        ...
        static carousel_bootInterface(t, e) {
            let i = w.get(t, "bs.carousel_boot"),
        ...
        static jQueryInterface(t) { return this.each((function() { Q.carousel_bootInterface(this, t) })) }
        static dataApiClickHandler(t) {
            const e = s(this);
            if (!e || !e.classList.contains("carousel_boot")) return;
            const i = {...U.getDataAttributes(e), ...U.getDataAttributes(this) },
                n = this.getAttribute("data-bs-slide-to");
            n && (i.interval = !1), Q.carousel_bootInterface(e, i), n && w.get(e, "bs.carousel_boot").to(n), t.preventDefault()
        }
    }
    H.on(document, "click.bs.carousel_boot.data-api", "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler), H.on(window, "load.bs.carousel_boot.data-api", () => { const e = t.find('[data-bs-ride="carousel_boot"]'); for (let t = 0, i = e.length; t < i; t++) Q.carousel_bootInterface(e[t], w.get(e[t], "bs.carousel_boot")) }), b(Q);
    ...
    return b(ri), { Alert: B, Button: W, carousel_boot: Q, Collapse: J, Dropdown: we, Modal: Ie, Offcanvas: Me, Popover: Je, ScrollSpy: ii, Tab: ni, Toast: ri, Tooltip: Xe }
}));
