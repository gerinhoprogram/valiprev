$(document).ready(function() {
    ...
    $("#fileuploader").uploadFile({
        url: BASE_URL + "restrita/dacao/upload_pdf",
        ...
        onSuccess: function(files, data) {
            if (data.erro === 0) {
                ...
                $("#uploaded_image").append(
					...
					'<a href="' + BASE_URL + 'uploads/paginas/dacao/pdf/' + data.uploaded_data['file_name'] + '" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a>'+
