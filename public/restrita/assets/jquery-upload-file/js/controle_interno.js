$(document).ready(function() {
    ...
    $("#fileuploader").change(function() {
        $('#carregando').html('<div class="p-1 mt-1 mb-1 rounded bg-warning text-dark"><img src="' + BASE_URL + 'public/restrita/assets/img/spinner.svg"> Aguarde o carregamento do(s) arquivo(s)...</div>');

    });

    $("#fileuploader").uploadFile({
        url: BASE_URL + "restrita/controle_interno/upload_pdf",
        ...
        onSuccess: function(files, data) {
            if (data.erro === 0) {
                ...
                $("#uploaded_image").append(
					...
					'<a href="' + BASE_URL + 'uploads/paginas/controle_interno/pdf/' + data.uploaded_data['file_name'] + '" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a>'+
