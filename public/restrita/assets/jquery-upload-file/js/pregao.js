$(document).ready(function() {
    ...
    $("#fileuploader").uploadFile({
        url: BASE_URL + "restrita/pregao/upload_pdf",
        ...
        onSuccess: function(files, data) {
            if (data.erro === 0) {
                ...
                $("#uploaded_image").append(
					...
					'<a href="' + BASE_URL + 'uploads/paginas/pregao/' + data.uploaded_data['file_name'] + '" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a>'+
					'<input type="text" class="form-control mt-2" value="' + data.nome + '" name="predoc_titulo[]">'+
					'<input type="text" class="form-control mt-2" readonly value="'+data.tamanho+'" name="predoc_tamanho[]">'+
					'<input type="hidden" name="predoc_arquivo[]" value="' + data.foto_nome + '">'+
