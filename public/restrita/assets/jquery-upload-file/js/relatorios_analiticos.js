$(document).ready(function() {
    ...
    $("#fileuploader").uploadFile({
        url: BASE_URL + "restrita/relatorios_analiticos/upload_pdf",
        ...
        onSuccess: function(files, data) {
            if (data.erro === 0) {
                ...
                $("#uploaded_image").append(
					...
					'<p><a href="' + BASE_URL + 'uploads/paginas/financeiro/relatorios_analiticos/' + data.uploaded_data['file_name'] + '" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a></p>'+
