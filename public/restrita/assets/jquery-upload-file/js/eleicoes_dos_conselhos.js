$(document).ready(function() {
    ...
    $("#fileuploader").uploadFile({
        url: BASE_URL + "restrita/eleicoes_dos_conselhos/upload_pdf",
        ...
        onSuccess: function(files, data) {
            if (data.erro === 0) {
                ...
                $("#uploaded_image").append(
					...
					'<a href="' + BASE_URL + 'uploads/paginas/eleicoes_dos_conselhos/pdf/' + data.uploaded_data['file_name'] + '" target="_blank"><i style="font-size: 25pt" class="far fa-file-pdf"></i></a>'+
					'<input type="text" class="form-control mt-2" value="' + data.nome + '" name="pdf_titulo[]">'+
					'<select name="pdf_tipo[]" class="form-control">'+
